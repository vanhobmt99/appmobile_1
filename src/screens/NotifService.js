...
export default class NotifService {
  ...
  localNotif(soundName, titleName, messageName) {
    this.lastId++;
    PushNotification.localNotification({
      ...
      //bigText: 'Bạn có đơn lắp đặt mới', // (optional) default: "message" prop
      subText: 'Thông báo', // (optional) default: none
      ...
      title: titleName, // (optional)
      message: messageName, // (required)
