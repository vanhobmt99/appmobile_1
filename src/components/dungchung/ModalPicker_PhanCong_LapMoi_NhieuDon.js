...
export function ModalPicker_PhanCong_LapMoi_NhieuDon(props)
{
    ...
    const _insertPhanCongLapMoi= async () => {
      for (const item of madon)
      {
        insertPhanCongThiCong(url, username, password, item, manv).then(obj => {
          if(obj.ResultCode === true){    
